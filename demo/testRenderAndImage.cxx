...
int main (int argc, char *argv[])
{
  ...
  /* // convert template_image from imagedata to polydata
  ...
  pol2stenc->SetInputData(imageDataGeometryFilter->GetOutput());
  pol2stenc->SetOutputOrigin(origin);
  pol2stenc->SetOutputSpacing(spacing);
  pol2stenc->SetOutputWholeExtent(oneFrame->GetExtent());
  pol2stenc->Update();
  

  vtkSmartPointer<vtkImageStencil> imgstenc = 
    vtkSmartPointer<vtkImageStencil>::New();
  imgstenc->SetInputData(oneFrame);
