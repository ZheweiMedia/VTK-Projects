...
class vtkTimerCallback():
   ...
   def execute(self,obj,event):
       ...
       #self.actor1.AddPosition(distance_eachSubjects*2-center_of_Subjects, height1*100/2+bottomLine1,0)
       #self.actor2.AddPosition(distance_eachSubjects*3-center_of_Subjects, height2*100/2+bottomLine2,0)
       iren = obj
