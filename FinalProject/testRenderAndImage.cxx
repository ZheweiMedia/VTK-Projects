...
int main (int argc, char *argv[])
{
  if (argc < 4)
    {
      std::cout << "Required arguments: MRI_file fMRI_file template_file ROI_index"
                << std::endl;
      std::cout << "For example:" << std::endl;
      std::cout << "Required arguments: 0917_MRI 0917_pp_A_0073.nii AAL2.nii 41" << std::endl;
      return EXIT_FAILURE;
    }
  ...
  MRI_mapper->SetInputData(MRI_Copy);
  ...
  MRI_ROI_volume->SetMapper(MRI_mapper);
  MRI_ROI_volume->SetProperty(MRI_Property);
